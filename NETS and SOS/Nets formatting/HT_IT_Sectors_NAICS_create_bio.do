/*
Creates HT, IT, and Software indicators for NETS (including Biotech)
...
forvalues i = 90(1) 99{
	...
	replace it_sector_`i' = 7 if ht_ind_`i' == 1
	...
	replace it_sector_`i' = 2 if inlist(HTNAICS, "334290", "334310")
	...
	replace it_sector_`i' = 6 if inlist(HTNAICS, "325411", "325412", "325413", ///
		"325414", "334510", "334511")
	replace it_sector_`i' = 6 if inlist(HTNAICS, "334512", "334513", "334514", ///
		"334515", "334516", "334517")
	replace it_sector_`i' = 6 if inlist(HTNAICS, "334519", "541711", "541712", ///
		"541720")
