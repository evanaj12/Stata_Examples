...
foreach i in NETSData SoSData {
	...
	* remove unnamed
	...
	if "`i'"=="NETSData" {
		keep cleaned_company cleaned_address_first cleaned_officer data dunsnumber
	}
	if "`i'"=="SoSData" {
		keep cleaned_company cleaned_address_first cleaned_officer data filing_number
	}
